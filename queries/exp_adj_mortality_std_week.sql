...
SELECT
    ...
    b.age_group,
    a.adj_mortality_std AS "mortality",
    a.adj_mortality_std_projected AS "mortality_projected",
    a.adj_mortality_std_lower_projected AS "mortality_lower_projected",
    a.adj_mortality_std_upper_projected AS "mortality_upper_projected",
    b.adj_mortality_std_trend AS "baseline_mortality",
    b.adj_mortality_std_stddev AS "baseline_mortality_stddev",
    b.population,
    a.has_projection
FROM
...
FROM
    ...
    LEFT JOIN deaths.exp_mortality_week b ON a.state = b.state
    AND a.age_group = b.age_group
