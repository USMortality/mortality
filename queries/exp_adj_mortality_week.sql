...
SELECT
    ...
    b.age_group,
    a.adj_mortality AS "mortality",
    a.adj_mortality_projected AS "mortality_projected",
    a.adj_mortality_lower_projected AS "mortality_lower_projected",
    a.adj_mortality_upper_projected AS "mortality_upper_projected",
    b.adj_mortality_trend AS "baseline_mortality",
    b.adj_mortality_stddev AS "baseline_mortality_stddev",
    b.population,
    a.has_projection
FROM
